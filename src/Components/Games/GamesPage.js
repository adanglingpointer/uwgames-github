      ...
      <div className="main-content">
        ...
        <div className="featured-games">
          ...
          <div className="game-boxes">
            ...
            <div className="game-box">
              <img src="game2.png" alt="Game 2" className="game-img" name="coaster" onClick={getClick} />
              <h3><span onClick={getClick} name="coaster" className="nav-link">Amusement Park Manager</span></h3>
              <p>
                <span onClick={getClick} name="coaster" className="nav-link">
